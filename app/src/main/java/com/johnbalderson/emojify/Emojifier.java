...
package com.johnbalderson.emojify;
...
class Emojifier {
    ...
    static Bitmap detectFacesAndOverlayEmoji(Context context, Bitmap picture) {
        ...
        // TODO (7): Create a variable called resultBitmap and initialize it to the original picture bitmap
        // passed into the detectFacesAndOverlayEmoji() method
            ...
            for (int i = 0; i < faces.size(); ++i) {
                ...
                switch (whichEmoji(face)) {
                    ...
                    default:
                        ...
                        // TODO (8): Call addBitmapToFace(), passing in the resultBitmap, the emojiBitmap and the Face  object,
